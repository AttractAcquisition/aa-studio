  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-transparent text-sm font-medium ring-offset-background transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-card/70 hover:bg-secondary/60 hover:text-secondary-foreground",
        ...
        lavender: "bg-lavender text-deep-ink hover:bg-lavender/90",
        pill: "rounded-full border border-primary/20 bg-primary/10 text-primary hover:bg-primary/15 uppercase tracking-[0.14em]",
      },
      size: {
